...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<List<CategoryModel>> categories});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({this.categories = const AsyncLoading()});
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final AsyncValue<List<CategoryModel>> categories}) =
      _$HomeStateImpl;
