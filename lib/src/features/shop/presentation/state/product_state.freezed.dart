...
abstract class $ProductStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<List<ProductModel>> products});
}
...
class _$ProductStateImpl implements _ProductState {
  const _$ProductStateImpl({this.products = const AsyncLoading()});
...
abstract class _ProductState implements ProductState {
  const factory _ProductState({final AsyncValue<List<ProductModel>> products}) =
      _$ProductStateImpl;
